...
public class Tab2 extends Activity 
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		final ProgressBar myPB = (ProgressBar) findViewById(R.id.progressBar2);
		final ImageView myImageView = (ImageView) findViewById(R.id.spotsImageView2);
		...
		if(MainActivity.networkConnected)
		{
			...
			webView.loadUrl("http://app.theparkingspot.com/mobile/Locations/FindLocation.aspx");
		}
		else
		{
			myPB.setVisibility(View.INVISIBLE);
